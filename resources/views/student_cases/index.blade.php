...
@section('title', 'Buku Kasus Siswa')
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        ...
        <div class="p-6 bg-white border border-gray-100 shadow-sm sm:flex sm:items-center rounded-2xl">
            <div class="sm:flex-auto">
                <h1 class="text-2xl font-bold text-gray-800">Buku Kasus Siswa</h1>
                <p class="mt-2 text-sm text-gray-500">Pencatatan pelanggaran, prestasi, dan catatan penting siswa.</p>
            </div>
        ...
        <div class="mt-6">
            <form action="{{ route('student_case.index') }}" method="GET" class="flex flex-wrap items-center gap-3">
                ...
                <select name="kategori" onchange="this.form.submit()"
                    ...
                    <option value="Pelanggaran" {{ $kategori == 'Pelanggaran' ? 'selected' : '' }}>Pelanggaran</option>
                ...
                <thead class="bg-purple-50">
                    <tr>
                        <th class="py-4 pl-6 pr-3 text-left text-xs font-black text-[#773DCE] uppercase tracking-wider">
                            Siswa</th>
                        <th class="px-3 py-4 text-left text-xs font-black text-[#773DCE] uppercase tracking-wider">Tanggal
                        </th>
                        <th class="px-3 py-4 text-left text-xs font-black text-[#773DCE] uppercase tracking-wider">Kategori
                        </th>
                        <th class="px-3 py-4 text-left text-xs font-black text-[#773DCE] uppercase tracking-wider">Judul
                            Kasus</th>
                        <th class="px-3 py-4 text-left text-xs font-black text-[#773DCE] uppercase tracking-wider">Dicatat
                            Oleh</th>
                    ...
                    @forelse($cases as $case)
                        <tr class="transition-colors hover:bg-gray-50/50">
                            <td class="py-4 pl-6 pr-3 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-[10px] text-gray-400">{{ $case->student->schoolClass->name }}
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-3 py-4 whitespace-nowrap">
                                @php
                                    $cat = ['Pelanggaran' => 'red', 'Prestasi' => 'green', 'Lainnya' => 'gray'];
                                    $c = $cat[$case->kategori] ?? 'gray';
                                @endphp
                                <span
                        ...
                        <tr>
                            <td colspan="6" class="py-12 text-center">
                                <div class="flex flex-col items-center">
                                    <i class="mb-3 text-4xl text-gray-200 fa-solid fa-triangle-exclamation"></i>
                                    <p class="text-sm font-medium text-gray-400">Belum ada catatan kasus.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
