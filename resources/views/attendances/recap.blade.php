...
@section('content')
<div x-data="keteranganModal()" @open-keterangan.window="openModal()">
<div class="p-8 bg-white border border-gray-100 shadow-sm rounded-[2rem]">
    ...
    <div class="flex flex-col justify-between gap-4 mb-8 md:flex-row md:items-center">
        ...
        {{-- TOMBOL INPUT KETERANGAN MANDIRI --}}
            ...
            <div class="flex gap-2 lg:flex-none">
                ...
                @if(request()->anyFilled(['search','school_class_id','start_date','end_date']))
                    <a href="{{ route('attendance.recap') }}"
                        class="p-2.5 text-red-500 bg-red-50 rounded-xl hover:bg-red-100 transition flex items-center justify-center">
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-sm text-gray-600 divide-y divide-gray-100">
                ...
                <tr class="transition hover:bg-gray-50/50">
                    ...
                    <td class="p-4 text-center">
                        @if($item->keterangan)
                            @php $warna = ['Izin'=>'blue','Sakit'=>'orange','Alpa'=>'red'][$item->keterangan] ?? 'gray'; @endphp
                            <span class="px-2.5 py-1 text-[10px] font-black text-{{ $warna }}-600 border border-{{ $warna }}-100 rounded-lg bg-{{ $warna }}-50">
...
{{-- MODAL INPUT KETERANGAN SISWA - MANDIRI, TIDAK BUTUH SCAN --}}
<div x-show="show" x-cloak
    ...
    <div class="w-full max-w-md p-8 mx-4 bg-white shadow-2xl rounded-3xl">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                <h3 class="text-lg font-bold text-gray-800">Input Keterangan Siswa</h3>
        ...
        <form action="{{ route('attendance.keterangan') }}" method="POST" class="flex flex-col gap-4">
            ...
            <div x-data="studentSearch()">
                ...
                <div x-show="open && results.length > 0" x-cloak
                    class="absolute z-[60] w-[calc(100%-4rem)] mt-1 bg-white border border-gray-200 rounded-xl shadow-xl max-h-48 overflow-y-auto">
                ...
                <div x-show="open && search.length > 1 && results.length === 0" x-cloak
                    class="absolute z-[60] w-[calc(100%-4rem)] mt-1 bg-white border border-gray-200 rounded-xl shadow-xl px-4 py-3 text-sm text-gray-400">
            ...
            <div>
                ...
                <input type="text" name="catatan_keterangan"
...
<script>
// Data siswa dari controller — tidak ada query PHP di dalam script
